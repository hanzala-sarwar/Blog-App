...
const page: React.FC<SearchPageProps> = async ({ searchParams }) => {
  ...
  // these above three are changed to below for await issue
      ...
      {Array.from({ length: 3 }).map((_, index) => (
        ...
        >
          <div className="p-6">
            ...
            <Skeleton className="mb-4 h-48 w-full rounded-xl bg-linear-to-br from-purple-100/50 to-blue-100/50 dark:from-purple-900/20 dark:to-blue-900/20" />
